...
export default function ContinueWatchingCard({ movie, onClick }) {
  return (
    <div
      onClick={onClick}
      className="min-w-[180px] bg-gray-900 rounded-xl shadow-md overflow-hidden hover:scale-105 transition-all cursor-pointer"
    >
      <div className="relative">
        <img
      ...
      <div className="p-3">
        <h3 className="text-white font-semibold text-sm">{movie.title || "Unknown"}</h3>
